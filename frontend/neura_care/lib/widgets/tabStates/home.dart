                      ...
                      if (diet == Diet.empty()) ...[
                              ...
                              ElevatedButton.icon(
                                onPressed: () async {
                                  try {
                                    ...
                                    if (user.token != null) {
                                      final dailyMeals =
                                          await getDailyMealsData(user.token!);
                                      ref
                                          .read(
                                            dailyMealsProviderNotifier.notifier,
                                          )
                                    ...
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text(
                                          "Failed to generate meals: ${e.toString()}",
                                        ),
                                        backgroundColor:
                        ...
                        Container(
                          ...
                          child: ElevatedButton.icon(
                            ...
                            label: Text(
                              "View ${_getMealTimeDisplay(currentMealTime)}",
                            ),
                            style: ElevatedButton.styleFrom(
                              backgroundColor: theme.colorScheme.primary,
                              foregroundColor: theme.colorScheme.onPrimary,
                                ...
                                (meal) => Expanded(
                                  child: Container(
                                    ...
                                    child: OutlinedButton.icon(
                                      ...
                                      icon: Icon(_getMealIcon(meal), size: 18),
                                      label: Text(
